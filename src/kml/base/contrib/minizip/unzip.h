...
#ifndef _ZLIB_H
#include <zlib.h> //KMR.  were using local version
#endif
 ...
 */
extern unzFile ZEXPORT libkml_unzAttach OF((voidpf stream, zlib_filefunc_def*));
extern voidpf  ZEXPORT libkml_unzDetach OF((unzFile*));
